...
## My lectures
- Can I use my own MBP, i.e. can the laptop screen be projected?
...
- PRAbook code tested?
  - https://doi.org/10.1007/978-3-031-16333-3_5
...
## Agenda
There will be four sessions of 1.5 hours each. We aim to include exercises in each session.

1. Introduction to PRA: Basic ideas & equations (**BC2: 18.1-18.6, PRA-BDT: 1-9**)
2. Model-based PRA - 1 (incl. NIMBLE example Spain) (**PRA-BDT: 7**)
3. (a) Model-based PRA - 2 (incl. NIMBLE example Spain) (**PRA-BDT: 7**)
   (b) Expanding the theory (incl. Interacting hazards) (**BC2: 18.7, PRA-BDT: 10-11, 18**)
4. (a) Introduction to BDT (**BC2: 19.1-19.3, BC1: 17.2, PRA-BDT: 12-15**)
   (b) Links between PRA and BDT (**BC2: 19.4, PRA-BDT: 16-17**)
   (c) General discussion (**BC2: 25.1, PRA-BDT: 19**)
...
- In structuring the course, mainly follow BC2, Chapters 18 and 19 [@VanOijen_2024_Bayesian]. But also check BC1 Ch. 17 for some material on BDT (regarding VoI) left out of BC2.
...
- What **not** to include? (Maybe mention briefly but not treated in any depth)
...
- Are Bayesian approaches to regression (incl. machine learning, CART) to be mentioned?
